...
class GameActivity : AppCompatActivity() {
    ...
    private lateinit var playerOnePoints:TextView
    private lateinit var playerTwoPoints:TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        playerOnePoints=findViewById(R.id.player_one_score)
        playerTwoPoints = findViewById(R.id.player_two_score)
    ...
    private fun updatePoints() {
        playerOnePoints.text = "Player X Points: ${gameManager.player1Points}"
        playerTwoPoints.text = "Player O Points: ${gameManager.player2Points}"
    }
